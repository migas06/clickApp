...
import com.example.viralclicker.domain.model.*
import com.example.viralclicker.domain.usecase.*
...
class GameViewModel @Inject constructor(
    ...
    fun onBoostRewarded() {
        viewModelScope.launch {
            val boostDurationMs = 30 * 60 * 1000L // 30 minutes
    ...
    private suspend fun emitState(offlineEarnings: ViralPoints? = null, noAds: Boolean? = null, dailyBonus: ViralPoints? = null) {
        ...
        _gameState.emit(
            GameState(
                ...
                pointsPerClick = ViralPoints.fromString(_player.pointsPerClick),
                pointsPerSecond = ViralPoints.fromString(_player.pointsPerSecond),
